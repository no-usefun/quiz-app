...
export default function TeacherDashboardError({
  ...
  useEffect(() => {
    console.error("Teacher dashboard error boundary caught an error:", error);
  }, [error]);
      ...
      <div className="w-full max-w-md rounded-[8.8px] bg-white border border-[#d1dee8] p-8 text-center shadow-sm space-y-4 text-left">
        ...
        <div className="text-center space-y-1">
          ...
          <h1 className="text-lg font-bold text-[#111111]">
            Failed to Load Instructor Console
          </h1>
          <p className="text-xs text-[#78716b] leading-relaxed font-medium">
            An unexpected error occurred while loading quizzes. Please click below to refresh the console.
          </p>
        </div>
