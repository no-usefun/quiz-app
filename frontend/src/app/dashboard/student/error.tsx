...
export default function StudentDashboardError({
  ...
  useEffect(() => {
    console.error("Student dashboard error boundary caught an error:", error);
  }, [error]);
      ...
      <div className="w-full max-w-md rounded-[8.8px] bg-white border border-[#d1dee8] p-8 text-center shadow-sm space-y-4 text-left">
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-[#78716b] leading-relaxed font-medium">
            An unexpected error occurred while loading your assessments. Please click below to refresh.
          </p>
        </div>
