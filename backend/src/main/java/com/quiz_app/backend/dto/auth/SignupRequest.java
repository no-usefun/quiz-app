...
public record SignupRequest(
        ...
        @NotBlank(message = "Email is required") @Email(message = "Email must be a valid email address") @Size(max = 255, message = "Email cannot exceed 255 characters") String email,
        ...
        @NotBlank(message = "Registration number is required") @Size(max = 30, message = "Registration number cannot exceed 30 characters") String registrationNo,
