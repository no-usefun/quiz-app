...
CREATE TABLE activity_logs (
    ...
    activity_type VARCHAR(30) NOT NULL CHECK (activity_type IN ('LOGIN', 'START_QUIZ', 'VIEW_QUESTION', 'ANSWER_SELECTED', 'ANSWER_CHANGED', 'QUESTION_SKIPPED', 'TAB_SWITCH', 'WINDOW_BLUR', 'WINDOW_FOCUS', 'FULLSCREEN_EXIT', 'NETWORK_LOST', 'NETWORK_RESTORED', 'AUTO_SAVE', 'SUBMIT', 'AUTO_SUBMIT', 'FACE_NOT_DETECTED', 'MULTIPLE_FACES', 'LOOKING_AWAY', 'VOICE_DETECTED', 'SUSPICIOUS_OBJECT', 'DEVICE_SWITCH', 'RIGHT_CLICK', 'COPY_ATTEMPT')),
