    ...
    public AuthResponse register(SignupRequest request) {
        ...
        if (request.registrationNo() != null && !request.registrationNo().isBlank()) {
            ...
            if (userRepository.existsByRegistrationNo(regNo)) {
                throw new UserAlreadyExistsException("Registration number " + regNo + " is already associated with an account");
            }
        }
        ...
        Role role = roleRepository.findByName(roleNameToFind)
                .orElseGet(() -> {
                    ...
                    newRole.setRoleName(roleNameToFind);
                    newRole.setDescription(roleNameToFind.equals("TEACHER") ? "Can create and manage quizzes" : "Can attempt quizzes");
        ...
        user.setRegistrationNo(request.registrationNo() != null && !request.registrationNo().isBlank() ? request.registrationNo().trim() : null);
